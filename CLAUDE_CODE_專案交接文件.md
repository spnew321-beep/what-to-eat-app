...
已經做出來、邏輯完整、可互動的部分:
- 5 個分頁:🗺️ 地圖・⭐ 收藏・👥 家人・🎯 決策・☰ 更多(第三個分頁從「群組」改名為「家人」)
...
- 👥 家人分頁:純粹的家人飲食偏好名單(新增/編輯/刪除),**不連結餐廳、不能組群組**;分頁下方有「🔒 加好友/建群組」尚未開放提示
...
### 👥 家人(原本叫「群組」,v4.3 改名)
單層畫面,就是一份家人名單(名字/代表色/飲食偏好),新增/編輯/刪除。**不分群組、不連結餐廳**,純粹是給小孩、長輩這種沒有自己帳號的家人留的飲食偏好備忘。畫面下方有「🔒 加好友/建群組」尚未開放提示,說明真好友系統是 Tier 2+ 才會做的全新功能,不是這份家人名單延伸出來的。
